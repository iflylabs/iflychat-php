...
class iFlyChatSettings {


    public $iflychat_settings;
...
/**
    ...
    'base' => 'http://localhost/iflychat-php/',
    ...
    /**
     * anon_change_name - Select whether user can change his/her name
     * Valid values are TRUE and FALSE
     * TRUE - Yes
     * FALSE - No
     */

    'anon_change_name' => TRUE,
    ...
    /**
     * allow_clear_room_history - Specify whether to allow users to clear all messages in a room
     *
     * Valid values are defined below:
     * 1 - Allow all users
     * 2 - Allow only moderators
    ...
    /**
     * enable_search_bar - Specify whether to display search bar in online user list
     * Valid values are TRUE and FALSE
     * TRUE - Yes
     * FALSE - No
     */
    ...
    /**
     * minimize_chat_user_list - Specify whether to minimize online user list on page load
     * Valid values are TRUE and FALSE
     * TRUE - Yes
     * FALSE - No
     */
    ...
    'load_async' => TRUE,
    /**
     * ajax_file - Do not change this value
     */
    'ajax_file' => 'ajax-chat.php',

    /**
     * mobile_file - Do not change this value
     */
